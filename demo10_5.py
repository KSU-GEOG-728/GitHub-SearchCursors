...
"""
    File name: demo10_5.py
    Author: Shawn Hutchinson
    Description:  Example 1 of implementing a search cursor with a where clause and field delimiters.
...
featureClass = "parks"
fieldName = "NAME"
delimField = arcpy.AddFieldDelimiters(featureClass, fieldName)
whereClause = delimField + " = 'Frank Anneberg Park'"
